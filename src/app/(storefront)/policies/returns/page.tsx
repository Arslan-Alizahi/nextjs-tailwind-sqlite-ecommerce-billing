      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        >
          ...
          <Card className="p-8 space-y-6">
            ...
            <div>
              <h2 className="text-2xl font-semibold text-gray-900 mb-3">1. Return Window</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div>
              <h2 className="text-2xl font-semibold text-gray-900 mb-3">2. Eligible Items</h2>
            ...
            <div>
              <h2 className="text-2xl font-semibold text-gray-900 mb-3">3. Non-Returnable Items</h2>
              <p className="text-gray-700 leading-relaxed mb-3">
            ...
            <div>
              <h2 className="text-2xl font-semibold text-gray-900 mb-3">4. How to Return an Item</h2>
              <p className="text-gray-700 leading-relaxed mb-3">
            ...
            <div>
              <h2 className="text-2xl font-semibold text-gray-900 mb-3">5. Return Shipping</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div>
              <h2 className="text-2xl font-semibold text-gray-900 mb-3">7. Exchanges</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div>
              <h2 className="text-2xl font-semibold text-gray-900 mb-3">8. Damaged or Defective Items</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div>
              <h2 className="text-2xl font-semibold text-gray-900 mb-3">9. Late or Missing Refunds</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div>
              <h2 className="text-2xl font-semibold text-gray-900 mb-3">10. Questions?</h2>
              <p className="text-gray-700 leading-relaxed">
